...
export default function Teste() {
    ...
    >
        <Flex
            ...
            height="20"
            width="100%"
            bgGradient="linear(90deg, #F78C1F 0%, #F92B7F 100%)"
            alignItems="center"
        >
            <Container maxWidth="1180px">
                <Flex align="center">
                    ...
                    <HStack spacing="9">
                        <Box tabIndex={0} style={tabActive === "home" ? { borderBottomWidth: 1, borderBottomColor: "white" } : {}}>
                            <Link
                                fontWeight="bold"
                                fontSize="18px"
                                lineHeight="24px"
                        ...
                        <Box  tabIndex={0} style={tabActive === "aplicativo" ? { borderBottomWidth: 1, borderBottomColor: "white" } : {}}>
                            <Link
                                fontWeight="medium"
                                fontSize="16px"
                                lineHeight="24px"
        ...
        >
            <Flex flex="1">
                <Container maxWidth="1180px">
                    <Grid templateColumns={{ md: "1fr 450px" }} gridTemplateAreas={{ sm: `'b' 'a'`, md: `'a b'` }} paddingTop="10">
                        <GridItem gridArea="a">
                            <Flex marginTop={{ sm: 8, md: 0 }} align="baseline" justify="center" flexDirection="column">
                                <Box fontSize={{ sm: "2xl", md: "4xl", lg: "5xl" }} fontWeight="bold" color="#000">
                                    <Text display="inline" >Acompanhe sua evolução do tratamento da paralisia facial com o aplicativo</Text>
                                    <Text style={{
                                        display: "inline",
